<template>
    <div v-if="Math.random() > 0.4" class="card animate-pulse">
        ...
        <div class="w-4/7 md:w-full px-6 py-4 space-y-4">
            ...
            <div class="flex">
                <div class="rounded-full bg-gray-400 h-6 w-6" />
                <div class="flex-1 ml-3 h-4 my-auto bg-gray-400 rounded" />
            </div>
        </div>
    </div>
    <div v-else class="card animate-pulse">
        <div class="w-full px-6 py-8 space-y-4">
            ...
            <div class="h-4 bg-gray-400 rounded" />
            <div class="h-4 bg-gray-400 rounded w-5/6" />
            <div class="hidden md:block h-4 bg-gray-400 rounded" />
            <div class="hidden md:block h-4 bg-gray-400 rounded w-3/4" />
            <div class="hidden md:block h-4 bg-gray-400 rounded w-1/2" />
        </div>
    </div>
</template>
